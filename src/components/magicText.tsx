...
export const MagicText: React.FC<MagicTextProps> = ({ text, indentClass = "ml-20 md:ml-70 xl:ml-98" }) => {
  ...
  return (
    <p
      ref={container}
      className="leading-snug gap-x-2 flex flex-wrap text-2xl md:text-5xl xl:text-5xl "
    >
      {words.map((word, i) => {
